...
from flowcoder.teams.fields import optional_bool_field, string_field
from flowcoder.teams.mailbox import validate_mailbox_id
from flowcoder.teams.progress import TeammateProgress
...
def resolve_team_dir(team_name: str) -> Path:
    ...
    return Path.home() / ".flowcoder" / "teams" / slug


def unique_team_name(team_name: str) -> str:
    slug = _sanitize_name(team_name)
    base_dir = Path.home() / ".flowcoder" / "teams"
