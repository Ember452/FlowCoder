...
双层存储：
- 用户级（~/.flowcoder/memories.md）：跨项目的用户偏好和纠正反馈
- 项目级（<project>/.flowcoder/memories.md）：项目特定知识
...
# 用户级记忆文件路径（~/.flowcoder/memories.md）
USER_MEMORIES_RELPATH = ".flowcoder/memories.md"
# 项目级记忆文件路径（<project>/.flowcoder/memories.md）
PROJECT_MEMORIES_RELPATH = ".flowcoder/memories.md"
...
# 用户级记忆分类标题（写入 ~/.flowcoder/memories.md）
_USER_LEVEL_HEADERS = {"用户偏好", "纠正反馈"}
# 项目级记忆分类标题（写入 <project>/.flowcoder/memories.md）
