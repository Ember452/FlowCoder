...
SELECTOR_SYSTEM_PROMPT = (
    "You are selecting memories that will be useful to FlowCoder as it processes "
    ...
    "FlowCoder as it processes the user's query (up to 5). Only include memories "
    ...
    "that are usage reference or API documentation for those tools (FlowCoder is "
