...
from flowcoder.config import MemoryConfig, MemoryProviderConfig
from flowcoder.memory.auto_memory import MemoryManager
from flowcoder.memory.providers.base import MemoryProvider
from flowcoder.memory.providers.contract import (
...
BUILTIN_MEMORY_PROVIDERS = {
    "builtin.markdown": "flowcoder.memory.providers.markdown:MarkdownMemoryProvider",
}
