...
from flowcoder.agents.parser import (
    AgentDef,
    AgentParseError,
    build_agent_def,
    parse_agent_file,
...
PROJECT_AGENTS_DIR = ".flowcoder/agents"
USER_AGENTS_DIR = "~/.flowcoder/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("flowcoder.agents.builtins")
