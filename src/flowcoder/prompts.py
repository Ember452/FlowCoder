...
IDENTITY_SECTION = PromptSection(
    ...
    priority=0,
    content=(
        "You are FlowCoder, an AI programming assistant running in the terminal. "
...
def build_system_prompt(
    ...
    if coordinator_mode:
        from flowcoder.teams.coordinator import get_coordinator_system_prompt
...
def build_environment_context(
    ...
    """构建对话环境上下文
    返回一个列表，里面有工作目录，当前的skill，可用的Agent"""
    parts = [
