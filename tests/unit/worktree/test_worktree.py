...
from flowcoder.config import ConfigError, WorktreeConfig, load_config
from flowcoder.worktree.changes import count_worktree_changes, has_worktree_changes
from flowcoder.worktree.integration import build_worktree_notice, generate_worktree_name
from flowcoder.worktree.manager import WorktreeError, WorktreeManager
from flowcoder.worktree.models import WorktreeSession
...
class TestWorktreeManager:
    ...
    def test_restore_session_rejects_invalid_persisted_name(self, manager):
        ...
        save_worktree_session(Path(manager.repo_root) / ".flowcoder", session)
