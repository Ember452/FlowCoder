...
class TestMCPToolWrapper:
    def test_name_format(self) -> None:
        ...
        from flowcoder.mcp.tool_wrapper import MCPToolWrapper
        from flowcoder.mcp.client import MCPClient
    ...
    def test_public_name_is_sanitized_but_mcp_name_is_preserved(self) -> None:
        from mcp import types as mcp_types
        from flowcoder.mcp.tool_wrapper import (
...
class TestMCPManagerPartialFailure:
    ...
    async def test_single_server_failure_does_not_block_others(self) -> None:
        from flowcoder.mcp.manager import MCPManager
        ...
        with patch("flowcoder.mcp.manager.MCPClient") as MockClient:
