...
def test_plan_directory_uses_project_flowcoder_plans(tmp_path) -> None:
    assert plan_directory(tmp_path) == tmp_path / ".flowcoder" / "plans"
...
def test_create_plan_path_creates_directory_and_markdown_path(tmp_path) -> None:
    ...
    assert path == tmp_path / ".flowcoder" / "plans" / "calm-river-0102-0304.md"
