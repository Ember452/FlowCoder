...
from flowcoder import __main__ as cli
...
def test_main_without_prompt_launches_tui(
    ...
    monkeypatch.setattr("flowcoder.app.FlowCoderApp", FakeApp)
    monkeypatch.setattr("flowcoder.core.driver.NoAltScreenDriver", object)
...
async def test_run_prompt_uses_shared_agent_factory(
    ...
    import flowcoder.agent.factory as agent_factory
